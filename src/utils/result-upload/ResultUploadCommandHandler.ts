...
export type Parser = (
	// For file-based parsers, data is file content. For directory-based parsers (e.g., Allure), data is
	// the directory path and the parser is responsible for its own I/O.
	data: string,
